  ...
  return (
    <div className="container mx-auto py-20">
      ...
      <div className="w-full ">
        ...
        <div className="w-full bg-[#F97316]">
            <p className="font-extrabold text-[50px]">Custom Gaskets</p>
            <p className="font-extrabold text-[50px]">Made Easy</p>
            <div className="border-[3px] max-w-[200px] border-[#20B7CC] my-4"></div>
            <p className="text-white max-w-xl">Get the perfect gasket for your needs with our precision manufacturing and automated
