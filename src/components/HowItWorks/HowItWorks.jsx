    ...
    return (
        <div className='container mx-auto pb-10 mt-10 '>
            ...
            <div className='grid grid-cols-1 md:grid-cols-4  gap-10 mt-20 mx-2 ms:mx-0 '>
                ...
                <div className='bg-white flex flex-col items-center shadow-xl rounded-sm  relative overflow-visible p-1 xl:p-5 ' style={{
                    boxShadow: '0 0 15px rgba(0, 0, 0, 0.15)',
                }}>
                ...
                <div className='bg-white flex flex-col  items-center shadow-2xl  rounded-sm p-1 xl:p-5  relative' style={{
                    boxShadow: '0 0 15px rgba(0, 0, 0, 0.15)',
                }}>
