    ...
    <div className='container mx-auto pb-10 mt-10 '>
        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-10 mt-20 mx-2 ms:mx-0 '>
            <div className='bg-white flex flex-col justify-center items-center shadow-2xl rounded-sm p-5 relative'>
                ...
                <p className='text-[18px] mt-2 text-center px-8 py-10 '>Upload your drawing (we only accept DWG or DXF files) </p>
                <Image src={step1} height={300} width={300} alt='step1' />
                <Button className='mt-4 inline-block px-5'>Get Instant Quote</Button>
            </div>
            <div className='bg-white flex flex-col items-center shadow-2xl rounded-sm p-5 relative'>
                <p className='border-2  inline-block p-2 rounded-full border-[#2563EB] px-3 left-5 text-xl font-medium  absolute -top-5 bg-white '>02</p>
                <p className='text-[18px] mt-2 text-center px-8 py-10'>Upload your drawing (we only accept DWG or DXF files) </p>
