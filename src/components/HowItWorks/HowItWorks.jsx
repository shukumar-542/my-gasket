    ...
    return (
        <div className='xl:container mx-auto pb-10 mt-10 px-2 '>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4  gap-4 mt-20 mx-2 ms:mx-0 '>
                <div className='bg-white flex flex-col justify-center items-center shadow-2xl rounded-3xl p-1 xl:p-5 relative' style={{
                ...
                <div className='bg-white flex flex-col items-center shadow-xl rounded-3xl  relative overflow-visible p-1 xl:p-5 ' style={{
                    boxShadow: '0 0 15px rgba(0, 0, 0, 0.15)',
                }}>
                ...
                <div className='bg-white flex flex-col  items-center shadow-2xl  rounded-3xl p-1 xl:p-5  relative' style={{
                    boxShadow: '0 0 15px rgba(0, 0, 0, 0.15)',
                }}>
