        ...
        <div className="grid grid-cols-1 md:grid-cols-3 justify-between gap-5 py-16">
          <div className="w-full">
            ...
            <div className="flex items-center gap-2 mb-2">
              <Image  src={arrowGreen} height={600} width={600} className="h-6 w-6" alt="img" />
          ...
          <div className="w-full">
            ...
            <div className="flex items-center gap-2 mb-2">
              <Image  src={arrowRed} height={600} width={600} className="h-6 w-6" alt="img" />
              <p className="text-xl">High-Temperature Resistance</p>
            </div>
            <div className="flex items-center gap-2 mb-2">
              <Image  src={arrowRed} height={600} width={600} className="h-6 w-6" alt="img" />
          ...
          <div className="w-full">
            <h1 className="text-[#3B82F6] text-[38px] font-bold mb-10">MAIN FEATURES</h1>
            <div className="flex items-center gap-2 mb-2">
              <Image  src={arrowBlue} height={600} width={600} className="h-6 w-6" alt="img" />
              <p className="text-xl">High-Temperature Resistance</p>
            </div>
            <div className="flex items-center gap-2 mb-2">
              <Image  src={arrowBlue} height={600} width={600} className="h-6 w-6" alt="img" />
